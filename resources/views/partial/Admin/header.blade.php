...
{{--                            <span--}}
{{--                                class="bg-danger dash-h-badge message-counter custom_messanger_counter">0<span--}}
{{--                                    class="sr-only"></span>--}}
{{--                        </a>--}}
{{--                    </li>--}}
{{--                @endif--}}
...
{{--                                <a href="#"--}}
{{--                                    class="dash-head-link mark_all_as_read_message">{{ __('Marl All As Read') }}</a>--}}
{{--                            </div>--}}
...
{{--                                <a href="#" class="dash-head-link mark_all_as_read">{{__('Marl All As Read')}}</a>--}}
{{--                            </div>--}}
