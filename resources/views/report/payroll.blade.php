    ...
    <div id="printableArea" >
        ...
        <div class="row mt-3">
            <div class="col">
                ...
                <div class="card p-4 mb-4">
                    ...
                    <h6 class="report-text mb-0">{{$filterYear['type'].' '.__('Payroll Summary')}}</h6>
                </div>
            </div>
            @if($filterYear['branch']!='All')
                <div class="col">
                    <div class="card p-4 mb-4">
                        <h7 class="report-text gray-text mb-0">{{__('Branch')}} :</h7>
                        <h6 class="report-text mb-0">{{$filterYear['branch']}}</h6>
                    </div>
                </div>
            @endif
            @if($filterYear['department']!='All')
                <div class="col">
                    <div class="card p-4 mb-4">
                        <h7 class="report-text gray-text mb-0">{{__('Department')}} :</h7>
                        <h6 class="report-text mb-0">{{$filterYear['department']}}</h6>
                    </div>
                </div>
            @endif
            ...
            <div class="col">
                <div class="card p-4 mb-4">
                    ...
                    <h6 class="report-text mb-0">{{$filterYear['dateYearRange']}}</h6>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3 col-xl-3">
                <div class="card p-4 mb-4">
                    <h7 class="report-text gray-text mb-0">{{__('Total Basic Salary')}} :</h7>
                    <h6 class="report-text mb-0">{{\Auth::user()->priceFormat($filterData['totalBasicSalary'])}}</h6>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3 col-xl-3">
                <div class="card p-4 mb-4">
                    <h7 class="report-text gray-text mb-0">{{__('Total Net Salary')}} :</h7>
                    <h6 class="report-text mb-0">{{\Auth::user()->priceFormat($filterData['totalNetSalary'])}}</h6>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3 col-xl-3">
                <div class="card p-4 mb-4">
                    <h7 class="report-text gray-text mb-0">{{__('Total Allowance')}} :</h7>
                    <h6 class="report-text mb-0">{{\Auth::user()->priceFormat($filterData['totalAllowance'])}}</h6>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3 col-xl-3">
                <div class="card p-4 mb-4">
                    <h7 class="report-text gray-text mb-0">{{__('Total Commission')}} :</h7>
                    <h6 class="report-text mb-0">{{\Auth::user()->priceFormat($filterData['totalCommision'])}}</h6>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3 col-xl-3">
                <div class="card p-4 mb-4">
                    <h7 class="report-text gray-text mb-0">{{__('Total Loan')}} :</h7>
                    <h6 class="report-text mb-0">{{\Auth::user()->priceFormat($filterData['totalLoan'])}}</h6>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3 col-xl-3">
                <div class="card p-4 mb-4">
                    <h7 class="report-text gray-text mb-0">{{__('Total Saturation Deduction')}} :</h7>
                    <h6 class="report-text mb-0">{{\Auth::user()->priceFormat($filterData['totalSaturationDeduction'])}}</h6>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3 col-xl-3">
                <div class="card p-4 mb-4">
                    <h7 class="report-text gray-text mb-0">{{__('Total Other Payment')}} :</h7>
                    <h6 class="report-text mb-0">{{\Auth::user()->priceFormat($filterData['totalOtherPayment'])}}</h6>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3 col-xl-3">
                <div class="card p-4 mb-4">
                    <h7 class="report-text gray-text mb-0">{{__('Total Overtime')}} :</h7>
                    <h6 class="report-text mb-0">{{\Auth::user()->priceFormat($filterData['totalOverTime'])}}</h6>
                </div>
            </div>
        </div>
    </div>
