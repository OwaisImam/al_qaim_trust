        ...
        <div class="m-header main-logo">
            <a href="<?php echo e(route('home')); ?>" class="b-brand">
                <!-- ========   change your logo hear   ============ -->
                    ...
                    alt="<?php echo e(config('app.name', 'HRMGo')); ?>" class="logo logo-lg">
                ...
                <?php if(Gate::check('Manage Department') ||
                    ...
                    <li class="dash-item dash-hasmenu">
                        <a href="<?php echo e(route('branch.index')); ?>" class="dash-link"><span class="dash-micon"><i
                                ...
                                class="dash-mtext"><?php echo e(__('System Setup')); ?></span></a>
                        </li>
                        <!-- <ul class="dash-submenu">
...
<?php /**PATH C:\xampp\htdocs\al_qaim_trust\resources\views/partial/Admin/menu.blade.php ENDPATH**/ ?>