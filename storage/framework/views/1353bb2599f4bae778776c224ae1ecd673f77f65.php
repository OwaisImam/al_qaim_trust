            ...
            <?php $__currentLoopData = $timesheetFilters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $timesheetFilter): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="col-3">
                        <div class="card p-4 mb-4 timesheet-card">
                            ...
                            <small class="report-text text-muted "><?php echo e(__('Total Working Hours')); ?> : <?php echo e($timesheetFilter->total); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\al_qaim_trust\resources\views/report/timesheet.blade.php ENDPATH**/ ?>