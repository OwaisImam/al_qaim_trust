    ...
    <nav class="navbar navbar-expand-md navbar-dark default top-nav-collapse">
        <div class="container">
            <a class="navbar-brand bg-transparent" href="#">
                ...
                <img src="<?php echo e($logos . '/' . (isset($company_logo_landing) && !empty($company_logo_landing) ? $company_logo_landing : 'logo-light.png')); ?>"
    ...
    <section class="">
        <div class="container">
            <div class="row align-items-center justify-content-end mb-5">
                ...
                <div class="col-sm-6">
                    <img src="<?php echo e(asset('assets/images/front/img-crm-dash-3.svg')); ?>"
            ...
            <div class="row align-items-center justify-content-start">
                <div class="col-sm-6">
                    <img src="<?php echo e(asset('assets/images/front/img-crm-dash-4.svg')); ?>"
...
<?php /**PATH /Users/owaisimam/PhpStormProjects/al_qaim_trust/resources/views/layouts/landing.blade.php ENDPATH**/ ?>