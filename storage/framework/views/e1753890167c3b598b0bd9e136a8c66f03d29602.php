                                    ...
                                    <td>
                                        <div class="btn btn-sm btn-info rounded"><?php echo e($leave['approved']); ?>
                                            ...
                                            <a href="#" class="text-white"
                                                ...
                                                data-ajax-popup="true" data-size="lg" data-title="<?php echo e(__('Approved Leave Detail')); ?>"
                                    ...
                                    <td>
                                        <div class="btn btn-sm btn-danger rounded"><?php echo e($leave['reject']); ?>
                                            ...
                                            <a href="#" class="text-white"
                                                ...
                                                data-title="<?php echo e(__('Rejected Leave Detail')); ?>" data-bs-toggle="tooltip"
                                    ...
                                    <td>
                                        <div class="m-view-btn btn btn-sm btn-warning rounded">
                                            ...
                                            <a href="#" class="text-white"
                                                ...
                                                class="table-action table-action-delete" data-size="lg" data-ajax-popup="true"
                                                data-title="<?php echo e(__('Pending Leave Detail')); ?>" data-bs-toggle="tooltip"
                                                title="<?php echo e(__('View')); ?>"
                                                data-original-title="<?php echo e(__('View')); ?>"><?php echo e(__('View')); ?></a>
                                        </div>
                                    </td>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\al_qaim_trust\resources\views/report/leave.blade.php ENDPATH**/ ?>